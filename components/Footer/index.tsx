  ...
  return (
    <>
      <footer
        ...
        data-wow-delay=".1s"
      >
        <div className="bg-gradient-to-r from-[#90da7f] from-10%  via-30% to-blue-500 to-90% p-4">
          {pathName === "/contact" ? "" : <ContactCard />}
          <div className="mx-auto flex flex-wrap justify-center">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="inline-block h-28">
                  <video
                    width="320"
                    height="240"
                    muted
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  Halka No.61, Survey No.156/1/1/1, Jamaniya Khurd, Indore,
                  Madhya Pradesh <br />
                  <span>GST No.- 23AXBPK9633R2ZW</span>
                </p>
              </div>
            </div>
          </div>
