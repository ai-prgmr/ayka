...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`header sticky left-0 top-0 z-40 flex w-full items-center border-b-2 border-gray-400 border-opacity-80 bg-gradient-to-r from-[#90da7f] from-10%  via-30% to-blue-500 to-90%`}
      >
